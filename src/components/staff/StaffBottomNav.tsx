...
import { CalenderIcon, TimeIcon, DollarLineIcon } from "@/icons";

const NAV_ITEMS = [
  { href: "/staff", label: "Today", icon: CalenderIcon },
  { href: "/staff/clock", label: "Clock", icon: TimeIcon },
  { href: "/staff/payroll", label: "Payroll", icon: DollarLineIcon },
];
