...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-y-auto modal z-[1001]">
      {!isFullscreen && (
        <div
          className="fixed inset-0 h-full w-full backdrop-blur-sm bg-black/30"
          onClick={onClose}
        ></div>
      )}
      <div
