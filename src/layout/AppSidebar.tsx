...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Clients",
    subItems: [
      { name: "CRM Dashboard", path: "/clients", pro: false },
      { name: "Messaging", path: "/clients/messaging", pro: false, new: true },
    ],
  },
  {
    name: "Team",
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Automated Billing", path: "/billing/automated", pro: false, new: true },
      { name: "Payments", path: "/billing/payments", pro: false },
    ],
  },
  {
    name: "Expenses",
    ...
    subItems: [
      ...
      { name: "Bank Import", path: "/expenses/import", pro: false, new: true },
      { name: "Receipts", path: "/expenses/receipts", pro: false },
    ],
  },
];
...
const othersItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Services & Pricing", path: "/settings/services", pro: false },
